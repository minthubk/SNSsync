...
public class ImageDownloader {
	...
	private String bitmapFileDirString;
	
	Context context;
	public ImageDownloader (Context context){
		this.context = context;
		bitmapFileDirString = context.getFilesDir() + "/";
	}
...
//            Log.w(LOG, url, e);
    ...
    private Bitmap getBitmapFromSDCard(String url) {
		...
		if (i < cacheFiles.length) {
			bitmap = BitmapFactory.decodeFile(bitmapFileDirString + fileName);
		}
